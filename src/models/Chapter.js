...
const mediaSchema = new mongoose.Schema({ assetId: { type: String, required: true }, resourceType: { type: String, enum: ["image", "video", "raw"], required: true }, mediaType: { type: String, enum: ["IMAGE", "VIDEO", "AUDIO", "VOICE"], required: true }, secureUrl: { type: String, required: true }, format: String, bytes: Number, width: Number, height: Number, duration: Number }, { _id: false });
