...
export const PUBLICATION_ACTIONS = ["DRAFT_CREATED", "DRAFT_UPDATED", "CHAPTER_ADDED", "CHAPTER_UPDATED", "CHAPTER_REMOVED", "CHAPTERS_REORDERED", "SUBMITTED", "RESUBMITTED", "APPROVED", "CHANGES_REQUESTED", "REJECTED", "ARCHIVED", "LEGACY_LINKED"];
