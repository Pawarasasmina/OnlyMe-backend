...
function serializeOwnProfile(user, profile) {
  ...
  if (effectiveProfileRole(user) === "creator") {
    serialized.profile = {
      ...
      directAccessEnabled: profile.directAccessEnabled,
      directAccessPriceStars: profile.directAccessPriceStars,
      directCallEnabled: profile.directCallEnabled,
      directCallPriceStars: profile.directCallPriceStars,
      directCallDurationMinutes: profile.directCallDurationMinutes,
