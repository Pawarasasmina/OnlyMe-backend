...
const mediaRule = (type) => type === "IMAGE" ? { resourceType: "image", formats: ["jpg", "jpeg", "png", "webp"] } : ["VIDEO"].includes(type) ? { resourceType: "video", formats: ["mp4", "mov", "webm"] } : ["AUDIO", "VOICE"].includes(type) ? { resourceType: "video", formats: ["mp3", "wav", "aac", "flac", "webm", "ogg", "mp4", "m4a"] } : null;
