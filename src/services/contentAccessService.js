const creatorSummary = (creator) => creator && ({ id: creator._id, name: creator.name, username: creator.username, avatar: creator.avatar, isVerified: Boolean(creator.isVerified) });
